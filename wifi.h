...
const char* ssid = "EZConnect"; //"Thanos Car";              // Network Name (e.g. EZConnect)
const char* password =  "Ccs768xDm3"; //"SugmaBalls";        // Password
...
void openWiFi() {
  ...
  if (wiFiAttemptCounter >= wiFiAttemptTotal) {
